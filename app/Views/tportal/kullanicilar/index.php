...
<?= $this->section('page_title') ?> Cariler <?= $this->endSection() ?>
<?= $this->section('title') ?> Cariler | Fams Otomotiv A.Ş. <?= $this->endSection() ?>
          ...
          <div class="nk-block-head nk-block-head-sm">
              <div class="nk-block-between">
                  <div class="nk-block-head-content">
                      <h3 class="nk-block-title page-title">Cariler</h3>
                      ...
                      <div class="card-inner p-0">
                          <div class="nk-tb-list nk-tb-ulist">
                              <div class="nk-tb-item nk-tb-head tb-tnx-head">
                                  ...
                                  <div class="nk-tb-col"><span class="sub-text">Ünvan / Yetkili</span></div>
                                  <div class="nk-tb-col tb-col-mb w-max-110px"><span class="sub-text">İletişim</span></div>
                              ...
                              <div class="nk-tb-item" data-url="<?= route_to('tportal.cariler.detay') ?>">
                                  <div class="nk-tb-col nk-tb-col-check">
                                      <div class="custom-control custom-control-sm custom-checkbox notext">
                                  ...
                                  <div class="nk-tb-col">
                                      <div class="user-card">
                                          ...
                                          <div class="user-info">
                                              <span class="tb-lead">FAMS OTOMOTİV <span class="dot dot-warning d-md-none ms-1"></span></span>
                                              <span>Fesih Bey</span>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="nk-tb-col tb-col-md">
                                    <div class="user-info">
                                        <span class="tb-lead">0532 369 63 66 <span class="dot dot-warning d-md-none ms-1"></span></span>
                                        <span>muhasebe@famsotomotiv.com</span>
                                    </div>
                                  </div>
                                  <div class="nk-tb-col tb-col-md">
                                       <span class="tb-amount text-success">90.000,00 <span class="currency text-success">₺</span></span>
                                  </div>
                                  <div class="nk-tb-col tb-col-md">
                                      <span class="tb-status text-success">Borçlu</span>
                                  </div>
                                  <div class="nk-tb-col nk-tb-col-tools  text-end">
                                    <a href="<?= route_to('tportal.cariler.detay') ?>" class="btn btn-round btn-icon btn-outline-light"><em class="icon ni ni-chevron-right"></em></a>
                                  </div>
                              ...
                              <div class="nk-tb-item" data-url="<?= route_to('tportal.cariler.detay') ?>">
                                ...
                                <div class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">KOBİKOM TELEKOMÜNİKASYON <span class="dot dot-warning d-md-none ms-1"></span></span>
                                            <span>Hakan Kovac</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                  <div class="user-info">
                                      <span class="tb-lead">0553 924 27 67 <span class="dot dot-warning d-md-none ms-1"></span></span>
                                      <span>hakan.kovac@kobikom.com.tr</span>
                                  </div>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                     <span class="tb-amount text-danger">-6.028,51 <span class="currency text-danger">₺</span></span>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                    <span class="tb-status text-danger">Alacaklı</span>
                                </div>
                                <div class="nk-tb-col nk-tb-col-tools  text-end">
                                  <a href="<?= route_to('tportal.cariler.detay') ?>" class="btn btn-round btn-icon btn-outline-light"><em class="icon ni ni-chevron-right"></em></a>
                                </div>
                            ...
                            <div class="nk-tb-item" data-url="<?= route_to('tportal.cariler.detay') ?>">
                                ...
                                <div class="nk-tb-col">
                                    <div class="user-card">
                                        <div class="user-avatar bg-lighter sq">
                                            <span>S</span>
                                        </div>
                                        <div class="user-info">
                                            <span class="tb-lead">SEVGİ EV YEMEKLERİ <span class="dot dot-warning d-md-none ms-1"></span></span>
                                            <span>Mehmet Söneryıldız</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                ...
                                <div class="nk-tb-col tb-col-md">
                                     <span class="tb-amount text-soft">0,00 <span class="currency text-soft">₺</span></span>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                    <span class="tb-status text-soft">-</span>
                                </div>
                                <div class="nk-tb-col nk-tb-col-tools  text-end">
                                  <a href="<?= route_to('tportal.cariler.detay') ?>" class="btn btn-round btn-icon btn-outline-light"><em class="icon ni ni-chevron-right"></em></a>
                                </div>
