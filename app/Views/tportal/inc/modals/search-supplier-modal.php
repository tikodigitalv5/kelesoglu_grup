<!-- Müşteri Seç Modal -->
<div class="modal fade" id="mdl_tedarikciSecs" style="background-color: rgba(0, 0, 0, 0.5);">
...
<script>
    ...
    $('#mdl_tedarikciSec').on('shown.bs.modal', function() {
