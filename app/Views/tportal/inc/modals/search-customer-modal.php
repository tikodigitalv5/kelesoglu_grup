    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Müşteri Seçiniz <em class="icon ni ni-info"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Bulmak istediğiniz müşterinin cari kodu, ünvanı, adı soyadını veya telefon tumarasını başında 0 olmadan yazınız. (en az 3 karakter giriniz.)"></em></h5>
...
<script>
    $('#mdl_customer_search').keyup(function(index) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '<?= route_to('tportal.cari.detailed_search') ?>',
            dataType: 'json',
            data: {
                fromWhere: "<?= $fromWhere ?>",
                search: searchWord,
