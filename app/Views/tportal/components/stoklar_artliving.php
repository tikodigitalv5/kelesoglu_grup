...
<div class="modal fade" id="modelArtliving"  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Artliving  Web Site İşlemleri</h5>
      ...
      <div class="form-group">
            <button type="button" style="width:100%;"  id="siteden_disari" class="btn btn-lg btn-secondary">App'den Siteye Aktar <em class="icon ni ni-arrow-right"></em></button>
...
<script>
    ...
    siteden_disari.click(function(){
        ...
        Swal.fire({
        title: 'Sitedeki ürünleri siparis.artliving.com.tr sitesine aktarmak istiyormusunuz?',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?= route_to('tportal.api.artliving_send_products') ?>',
                dataType: 'json',
                data: {
