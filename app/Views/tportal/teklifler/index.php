                                                                ...
                                                                <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                                    ...
                                                                    <div class="dropdown-body dropdown-body-rg">
                                                                        <div class="row gx-6 gy-3">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label class="overline-title overline-title-alt">Müşteri Seç</label>
                                                                                    <select class="form-select musteriGore js-select2" data-search="off" id="musteriGore" data-placeholder="Müşteri Seç">
                                                                        ...
                                                                        <?php } endif; ?>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label class="overline-title overline-title-alt">Teklif Durumları</label>
                                                                                    <select class="form-select durumaGore js-select2" data-search="off" id="durumaGore" data-placeholder="Sipariş Durumu">
                                                                        <option value="0" selected>Hepsi</option>

                                                                        <option value="new" >Yeni Teklif</option>
                                                                        <option value="pending" >Teklif İnceleniyor</option>
                                                                        <option value="success" >Teklif Kabul Edildi</option>
                                                                        <option value="failed" >Teklif Reddelidi</option>
                            ...
                            <table id="datatableStock" class="nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                <thead>
                                    <tr class="nk-tb-item nk-tb-head tb-tnx-head">
                                        ...
                                        <th class="nk-tb-col" wdith="1%"><span class="sub-text">Teklif Tarihi</span></th>
                                       
                                        <!-- <th class="nk-tb-col tb-col-mb"><span class="sub-text">Kodu</span></th> -->
                                        <th class="nk-tb-col tb-col-lg" data-orderable="false"><span class="sub-text">Teklif No</span></th>
...
if (filterValue) {
   ...
   $(document).ready(function() {
    ...
    var table = NioApp.DataTable('#datatableStock', {
        ...
        ajax: {
            url: base_url + '/tportal/offer/getOfferList/' + lastPart,
            data: function(d) {
        ...
        createdRow: (row, data, dataIndex, cells) => {
            ...
            $(row).on('click', function() {
                ...
                window.location.href = '../detail/' + data.offer_id;
                });
                <?php endif; ?>
        },
        columns: [{
                ...
                render: function(data) {
                    ...
                    <div class="custom-control custom-control-sm custom-checkbox notext datatable-checkbox-container">
                        <input type="checkbox"  class="custom-control-input datatable-checkbox" data-id="${data.offer_id}" data-stock-no="${data.offer_id}" id="stockRow_${data.offer_id}"  ${disabled} >
                        <label class="custom-control-label datatable-checkbox-label" for="stockRow_${data.offer_id}"></label>
                    </div>`;
                }
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    var datetime = new Date(row.offer_date);
...
var timeStr = hours + ":" + minutes + ":" + seconds;
    ...
    render: function(data, type, row) {
        ...
        return `<div style="display:flex;">${kk_logo}<a href="../detail/${row.offer_id}" class="btn btn-round btn-icon btn-outline-light"><em class="icon ni ni-chevron-right"></em></a></div>`;
    }
}
        ],
    });
    ...
    onBeforeOpen: () => {
        ...
        return end >= start;
            ...
            if (validateDateRange(startDate, endDate)) {
                ...
                table.ajax.url(base_url + '/tportal/offer/getOfferList/' + lastPart + '?start_date=' + startDate + '&end_date=' + endDate).load();
            } else {
                Swal.fire({
                    icon: 'warning',
...
$('.toplu_islem').on('change', function() {
    ...
    if (validateDateRange(startDate, endDate)) {
        ...
        var ajaxUrl = base_url + '/tportal/offer/getOfferList/' + lastPart + 
    ...
    var lastPart = parts[parts.length - 1];
        ...
        table.ajax.url(base_url + '/tportal/offer/getOfferList/' + lastPart).load();
    });
