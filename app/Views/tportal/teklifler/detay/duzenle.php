...
<?= $this->section('page_title') ?> Teklif Düzenle <?= $this->endSection() ?>
<?= $this->section('title') ?> Teklif Düzenle | <?= session()->get('user_item')['firma_adi'] ?><?= $this->endSection() ?>
        ...
        <div class="nk-content-body">
            <div class="components-preview wide-xl mx-auto">
                ...
                <!-- <div class="example-alert">
                    <div class="alert alert-primary alert-icon"><em class="icon ni ni-alert-circle"></em> <strong>Teklif oluştur sayfasından çoğaltıldı</strong>. Tasarım değiştirilip siparişler olarak devam edecek.</div>
                </div>
                <hr> -->
                                        ...
                                        <div class="row g-3 align-center">
                                            ...
                                            <div class="col-lg-6 col-xxl-6 mt-0 mt-md-2">
                                                <div class="input-group">
                                                    <input type="text" class="form-control  form-control-lg form-control-lg" id="identification_number" name="identification_number" placeholder="T.C. veya Vergi No Giriniz.." maxlength="11" value="<?= $offer_item['cari_identification_number'] == 0 ? '' : $offer_item['cari_identification_number'] ?>">
                                        ...
                                        <div id="customer_info_area" class="gy-2">
                                                    ...
                                                    <div class="col-lg-6 col-xxl-6 col-6 mt-0 mt-md-2 pe-1">
                                                        <div class="form-group">
                                                            <select class="form-select js-select2" id="obligation" name="obligation" data-ui="lg" data-search="on" data-placeholder="Mükellefiyet Seçiniz">
                                                                <option></option>
                                                                <option value="e-archive" <?php if ($offer_item['cari_obligation'] == 'e-archive') {
                                                                                                echo "selected";
                                                                                            } ?>>
                                                                    E-Arşiv Fatura</option>
                                                                <option value="e-invoice" <?php if ($offer_item['cari_obligation'] == 'e-invoice') {
                                                                                                echo "selected";
                                                                                            } ?>>
                                                                    E-Fatura</option>
                                                            </select>
                                                    ...
                                                    <div class="col-lg-6 col-xxl-6 col-6 mt-0 mt-md-2 ps-1">
                                                        <div class="form-group">
                                                            <select id="company_type" name="company_type" class="form-select js-select2" data-ui="lg" data-placeholder="Şirket Tipi Seçiniz" data-search="on">
                                                                <option></option>
                                                                <option value="person" <?= $offer_item['cari_company_type'] == 'person' ? "selected" : '' ?>>Şahıs</option>
                                                                <option value="company" <?= $offer_item['cari_company_type'] == 'company' ? "selected" : '' ?>>Şirket</option>
                                                                <option value="public" <?= $offer_item['cari_company_type'] == 'public' ? "selected" : '' ?>>Kamu</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control  form-control-lg form-control-lg" name="invoice_title" id="invoice_title" value="<?= $offer_item['cari_invoice_title'] ?>" placeholder="Teklif Ünvanı">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center" id="namesurname">
                                                ...
                                                <div class="col mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control  form-control-lg form-control-lg" id="name" name="name" value="<?= $offer_item['cari_name'] ?>" placeholder="Adı">
                                                    </div>
                                                </div>
                                                <div class="col mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control  form-control-lg form-control-lg" id="surname" name="surname" value="<?= $offer_item['cari_surname'] ?>" placeholder="Soyadı">
                                                    </div>
                                                </div>
                                            </div>

                                            <input type="hidden" name="cari_id" id="cari_id" value="<?= $offer_item['cari_id'] ?>">
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control  form-control-lg form-control-lg" name="tax_administration" id="tax_administration" value="<?= $offer_item['cari_tax_administration'] ?>" placeholder="Vergi Dairesi">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <textarea class="form-control  form-control-lg form-control-lg" name="address" id="address" cols="30" rows="5" placeholder="Teklif Adresi"><?= $offer_item['address'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-3 col-xxl-3 col-6 mt-0 mt-md-2">
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="hidden" name="address_city_plate" id="address_city_plate" value="<?= $offer_item['address_city_plate'] ?>">
                                                ...
                                                <div class="col-lg-4 col-xxl-4 col-6 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="address_district" id="address_district" value="<?= $offer_item['address_district'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-3 col-xxl-3 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control  form-control-lg form-control-lg" id="zip_code" name="zip_code" value="<?= $offer_item['address_zip_code'] == 0 ? '' : $offer_item['address_zip_code'] ?>" placeholder="Posta Kodu">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text" class="form-control  form-control-lg form-control-lg" id="cari_email" value="<?= $offer_item['cari_email'] ?>" placeholder="Cari e-posta" name="cari_email">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg" name="cari_phone" id="cari_phone" aria-label="Carinin iletişim için telefon numarası" placeholder="000 000 0000" value="<?php if ($offer_item['cari_phone'] != 0) {
                                                                                                                                                                                                                                                                    $phone = explode(" ", $offer_item['cari_phone']);
                                                                                                                                                                                                                                                                    echo $phone[1];
                                    ...
                                    <div class="tab-pane " id="tabItem3" role="tabpanel">
                                        ...
                                        <div class="row g-3 align-center">
                                            <div class="col-lg-5 col-xxl-3 ">
                                                <div class="form-group">
                                                    <label class="form-label" for="fatura_para_birimi">Teklif Durmunu</label>
                                                    <span class="form-note d-none d-md-block">Teklif durmunu seçiniz</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex flex-nowrap col-lg-7 col-xxl-7">
                                                <div class="col-lg-6 col-xxl-5 col-6 mt-0 mt-md-2 pe-1">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-select-lg js-select2 form-control slct_offer_status" data-ui="lg" id="slct_offer_status" satir="0" data-ui="lg" data-placeholder="Seçiniz">
                                                            <option></option>
                                                            ...
                                                            <option value="failed" <?= $offer_item['offer_status'] == 'failed' ? "selected" : '' ?> disabled>Teklifi Siparişe Dönüştür</option>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-select-lg js-select2 form-control slct_doviz_tipi" data-ui="lg" data-search="on" id="slct_doviz_tipi" satir="0" data-ui="lg" data-placeholder="Seçiniz">
                                                            ...
                                                            <?php foreach ($money_unit_items as $money_unit_item) { ?>
                                                                <option value="<?= $money_unit_item['money_unit_id'] ?>" data-money-unit-code="<?= $money_unit_item['money_code'] ?>" data-money-unit-icon="<?= $money_unit_item['money_icon'] ?>" <?php if ($offer_item['money_unit_id'] == $money_unit_item['money_unit_id']) {
                                                                                                                                                                                                                                                        echo "selected";
                                                                                                                                                                                                                                                    } ?>>
                                                        ...
                                                        <input type="hidden" id="base_slct_doviz_tipi" value="<?= $offer_item['money_unit_id'] ?>">

                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xxl-5 col-4 mt-0 mt-md-2 ps-1 d-none" id="txt_doviz_kuru_area">
                                                    <div class="input-group">
                                                        <input type="text" name="txt_doviz_kuru" id="txt_doviz_kuru" class="form-control form-control-lg form-control-lg text-end " placeholder="0,0000" onkeypress="return SadeceRakam(event,[',']);" value="<?= number_format($offer_item['currency_amount'], 2, ',', '.') ?>">
                                                        <div class="input-group-append">
                                                ...
                                                <div class="col-lg-6 col-xxl-5 col-6 mt-0 mt-md-2 pe-1">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg date-picker" name="offer_date" value="<?= convert_date_for_view($offer_item['offer_date']) ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xxl-5 col-4 mt-0 mt-md-2 ps-1">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg time-picker" name="offer_time" value="<?= convert_time_for_form($offer_item['offer_date']) ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row g-3 align-center">
                                            ...
                                            <div class="col-lg-6 col-xxl-7  mt-0 mt-md-4">
                                                <ul class="custom-control-group">
                                                    <li>
                                                        <div class="custom-control custom-checkbox custom-control-pro">
                                                            <input type="checkbox" class="custom-control-input" name="is_validity" id="is_validity" <?= $offer_item['is_validity'] == 1 ? 'checked' : '' ?>>
                                        ...
                                        <div class="row g-3 align-center <?= $offer_item['is_validity'] == 1 ? '' : 'd-none' ?>" id="is_validity_area">
                                            <div class="col-lg-5 col-xxl-3 ">
                                                <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-xxl-3 col-6 mt-0 mt-md-2 pe-1">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg date-picker" name="validity_date" id="validity_date" value="<?= $offer_item['is_validity'] == 1 ? convert_date_for_view($offer_item['validity_date']) : date('d/m/Y') ?>" placeholder="Termin Tarihi">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="fatura_satirlar">
                                            ...
                                            foreach ($offer_rows as $offer_row) {   ?>
                                                ...
                                                <div class="row no-gutters mb-2 ftr_str " id="Satir_<?= $startZero ?>" visible="true" offer_row_id="<?= $offer_row['offer_row_id'] ?>">
                                                    <div class="col-lg-11">
                                                        <div class="row no-gutter">
                                                            <div class="col-lg-3 col-sm-6 pe-sm-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap str_kaldir">
                                                                        <div class="input-group">
                                                                            <input type="text" satir="<?= $startZero ?>" class="form-control" urun_id="<?= $offer_row['stock_id'] ?>" str_id="<?= $startZero ?>" id="txt_aciklama_<?= $startZero ?>" value="<?= $offer_row['stock_title'] ?>">
                                                                            <div class="input-group-append">
                                                                ...
                                                                <div class="row  g-1">
                                                                    <div class="col-lg-3 col-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                <input type="text" class="form-control   text-end px-1 ftr_hesap para" placeholder="0" id="txt_miktar_<?= $startZero ?>" satir="<?= $startZero ?>" value="<?= number_format($offer_row['stock_amount'], 2, ',', '.') ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-5 col-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                ...
                                                                                <input type="hidden" name="base_slct_birim" id="base_slct_birim_<?= $startZero ?>" value="<?= $offer_row['unit_id'] ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4 col-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                <input type="text" class="form-control   text-end px-1 ftr_hesap para" id="txt_birim_fiyat_<?= $startZero ?>" placeholder="0,00" satir="<?= $startZero ?>" value="<?= number_format($offer_row['unit_price'], 2, ',', '.') ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-1">
                                                                    <div class="col-lg-6 col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                <input type="text" class="form-control   text-end px-1 ftr_hesap para ftr_hesap para ftr_hesap_iskonto_yuzde" placeholder="0" id="txt_iskonto_orani_<?= $startZero ?>" satir="<?= $startZero ?>" value="<?= number_format($offer_row['discount_rate'], 2, ',', '.') ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                ...
                                                                                <input type="text" class="form-control   text-end px-1 ftr_hesap para ftr_hesap para txt_iskonto_tutari" id="txt_iskonto_tutari_<?= $startZero ?>" placeholder="0,00" satir="<?= $startZero ?>" value="<?= number_format($offer_row['discount_price'], 2, ',', '.') ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-1 col-sm-4 col-md-2 col-4 pe-sm-1 ps-sm-0">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap str_kaldir">
                                                                        <input type="text" class="form-control   text-end px-1 ftr_hesap para" value="<?= number_format($offer_row['subtotal_price'], 2, ',', '.') ?>" disabled="" id="txt_ara_toplam_<?= $startZero ?>" placeholder="" satir="<?= $startZero ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2 col-sm-4 col-8 pe-sm-1 ps-sm-0">
                                                                <div class="row g-1">
                                                                    <div class="col-lg-6 col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                ...
                                                                                <input type="hidden" name="base_slct_kdv" id="base_slct_kdv_<?= $startZero ?>" value="<?= $offer_row['tax_id'] ?>">
                                                                    ...
                                                                    <div class="col-lg-6 col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                <input type="text" class="form-control text-end px-1 para" id="txt_kdv_<?= $startZero ?>" placeholder="0,00" satir="<?= $startZero ?>" value="<?= $offer_row['tax_price'] ?>" disabled="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap str_kaldir">
                                                        ...
                                                        <input type="hidden" name="base_slct_note" id="base_slct_note" value="<?= $offer_item['offer_note_id'] ?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-5 bg-white">
                                            <button type="button" class="btn btn-secondary mb-2 btnPrevious" id="prevButton">Önceki</button>
                                            <button type="button" class="btn btn-success mb-2 btnEditOffer" id="btnEditOffer">Teklif Kaydet</button>
                                        </div>
...
<?= view_cell(
    ...
    [
        'element' => 'success_edit_offer',
        'modals' => [
            'ok' => [
                'modal_title' => 'İşlem Başarılı!',
                'modal_text' => 'Teklif başarıyla düzenlendi.',
