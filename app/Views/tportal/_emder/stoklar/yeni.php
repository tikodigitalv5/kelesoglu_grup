<div class="gy-3">
                                                ...
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                ...
                                                                placeholder="Gözükecek ürün adı">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                ...
                                                                value="" placeholder="Gözükecek ürün kodu" name="stock_code"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                ...
                                                                value="" placeholder="" name="pattern_code">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-5 col-xxl-5 ">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            class="form-note d-none d-md-block">Ürünün varsa tedarikçi kodu.</span></div>
                                                </div>
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                ...
                                                                placeholder="Ürünün varsa tedarikçi kodu" name="supplier_stock_code">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center d-none">
                                                <div class="col-lg-5 col-xxl-5 ">
                                                    <div class="form-group"><label class="form-label"
                                                            for="warehouse_address">Depo
                                                            Raf Adresi</label><span
                                                            class="form-note d-none d-md-block">Ürünün depodaki raf bilgisi</span></div>
                                                </div>
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                class="form-control form-control-xl"
                                                                id="warehouse_address" value="" placeholder=""
                                                                name="warehouse_address"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center d-none">
                                                    ...
                                                    <div class="col-8 pe-2">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap"><input type="text"
                                                                    ...
                                                                    value="" placeholder="15,87" name="buy_unit_price" onkeypress="return SadeceRakam(event,[',','-']);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            <div class="form-control-wrap ">
                                                                <div class="form-control-select">
                                                                    <select required=""
                                                                        class="form-control select2 form-control-xl"
                                                                        name="buy_money_unit_id" id="money_unit_id">
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-5 col-xxl-5 ">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            class="form-note d-none d-md-block">Ürünün kritik stok miktarı.</span></div>
                                                </div>
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                class="form-control form-control-xl"
                                                                id="critical_stock" value="" placeholder="Ürünün kritik stok miktarı"
