...
<?= $this->section('page_title') ?> Tüm Alt Ürünler <?= $this->endSection() ?>
<?= $this->section('title') ?> Tüm Alt Ürünler | <?= session()->get('user_item')['firma_adi'] ?><?= $this->endSection() ?>
                            ...
                            <div class="card-title-group">
                                <div class="card-tools">
                                    <div class="form-inline flex-nowrap gx-3">
                                        ...
                                        <div class="btn-wrap">
                                            <span class="d-none d-md-block"> <a href="<?= route_to('tportal.stocks.list','all') ?>" class="btn btn-dim btn-outline-primary">Ana Ürünlere Dön</a> </span>
                                            <span class="d-md-none"><button class="btn btn-dim btn-outline-light btn-icon disabled"><em class="icon ni ni-arrow-right"></em></button></span>
                                        </div>
                                    </div><!-- .form-inline -->
                                </div><!-- .card-tools -->
                            ...
                            <div class="card-search search-wrap" data-search="search">
                                <div class="card-body">
                                    <div class="search-content">
                                        ...
                                        <button class="search-submit btn btn-icon" style="margin-right: 60px;" id="stock_input_search_clear_button" name="stock_input_search_clear_button"><em class="icon ni ni-trash"></em></button>
                                    </div>
                                </div>
                            </div><!-- .card-search -->
                        </div><!-- .card-inner -->
                            ...
                            <table id="datatableStock" class="nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                <thead>
                                    <tr class="nk-tb-item nk-tb-head tb-tnx-head">
                                        ...
                                        <th class="nk-tb-col"><span class="sub-text">Ürün Bilgileri</span></th>
                                        <th class="nk-tb-col tb-col-lg" data-orderable="false"><span class="sub-text">Üst Ürün Bilgileri</span></th>
                                        <th class="nk-tb-col tb-col-md" data-orderable="false"><span class="sub-text">Kategori</span></th>
                                        <th class="nk-tb-col tb-col-md" data-orderable="false"><span class="sub-text">Stokta</span></th>
                                        <th class="nk-tb-col tb-col-lg" data-orderable="false"><span class="sub-text">Satış Fiyatı</span></th>
                                        <th class="nk-tb-col tb-col-md" data-orderable="false"><span class="sub-text"></span></th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                            </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = NioApp.DataTable('#datatableStock', {
            ...
            ajax: {
                url: base_url + '/tportal/stock/substocksDatatable',
                data: function(d) {
            ...
            columns: [{
                    ...
                    render: function(data) {
                        ...
                        <div class="custom-control custom-control-sm custom-checkbox notext datatable-checkbox-container">
                            <input type="checkbox" class="custom-control-input datatable-checkbox" data-id="${data.child_id}" data-stock-no="${data.child_id}" id="stockRow_${data.child_id}">
                            <label class="custom-control-label datatable-checkbox-label" for="stockRow_${data.child_id}"></label>
                        </div>`
                    }
                },
                {
                    data: null,
                    name: 'stock_stock_title',
                        ...
                        <td class="nk-tb-col">
                            <div class="user-card">
                                <div class="user-avatar">
                                    <img class="w-100 h-100" src="${ base_url+"/"+data.default_image }" alt="${ data.stock_stock_title }">
                                </div>
                                <div class="user-info">
                                    <span class="lead-text">${ data.stock_stock_title }</span>
                                    <span class="sub-text">${ data.child_stock_code }</span>
                                </div>
                            </div>
                        </td>
                            `;
                ...
                {
                    data: null,
                    name: 'parent_stock_title',
                    className: 'nk-tb-col tb-col-md',
                    render: function(data) {
                        return `
                        <td class="nk-tb-col tb-col-lg">
                            <span class="tb-amount">${ data.parent_stock_title }</span>
                            <span class="sub-text">${ data.parent_stock_code }</span>
                        </td>
                        `;
                    }
                },
                {
                    ...
                    render: function(data) {
                        return `
                        <td class="nk-tb-col tb-col-lg">
                            <span class="tb-amount">${ data.category }</span>
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        <td class="nk-tb-col tb-col-lg">
                            ...
                            <span class="sub-text">${ data.unit_title }</span>
                        </td>
                        `;
                    }
                },
                {
                    ...
                    className: 'nk-tb-col tb-col-md',
                    render: function(data) {
                        var formattedPrice = numberFormat(data.unit_price, 2, ',', '.');
                        return `
                        <td class="nk-tb-col tb-col-lg">
                            <span class="tb-amount">${ formattedPrice } ${ data.sale_money_icon }</span>
                        </td>
                        `;
                    }
                },
                {
                    ...
                    render: function(data) {
                        ...
                        <td class="nk-tb-col nk-tb-col-tools  text-end">
                            <a href="../stock/detail/${data.child_id}" class="btn btn-round btn-icon btn-outline-light"><em class="icon ni ni-chevron-right"></em></a>
                        </td>
                        `;
                    }
                },
        ...
        //     Swal.fire({
        //         title: 'Tüm kayıtlar getirilsin mi?',
        //         html: 'Tüm kayıtları getirmek üzeresiniz. <br> Bu işlemin tamamlanması biraz zaman alabilir. <br> Devam etmek istiyor musunuz?',
        //         icon: 'warning',
        ...
        //             Swal.fire({
        //                 title: 'Kayıtlar getiriliyor, lütfen bekleyiniz...',
        //                 html: 'Tüm kayıtlar getirilirken lütfen bekleyiniz...',
        //                 allowOutsideClick: false,
        //                 onBeforeOpen: () => {
        //                     Swal.showLoading();
        //                 },
        ...
        $(document).on('click', '.datatable-checkbox-label', function() {
            selectAll = false;
            $('#selectAllFaturalar').prop('checked', false);
        });
