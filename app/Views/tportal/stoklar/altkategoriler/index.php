                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head tb-tnx-head">
                                    ...
                                    <div class="nk-tb-col"><span class="sub-text"><?php echo $title_new; ?> Adı</span></div>
                                    <div class="nk-tb-col"><span class="sub-text"> Resim</span></div>
                              ...
                              foreach($category_items as $category_item){ ?>
                                ...
                                <div class="nk-tb-item" data-url="'.route_to('tportal.stoklar.detay').'"
                                    id="category_'.$category_item['alt_category_id'].'">
                                    <div class="nk-tb-col nk-tb-col-check">
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                    ...
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $category_item['alt_category_title'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col">
                                        ...
                                        <div class="user-avatar bg-transparent lg mt-3 mb-3">
                                                            <a class="gallery-image popup-image" href="<?= get_image_url($category_item['default_image'] ?? null); ?>">
                                                                <img src="<?= get_image_url($category_item['default_image'] ?? null); ?>" alt="image" class="w-100 rounded-top">
                                                            </a>
                                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col tb-col-md">
                                        <div class="custom-control custom-switch ps-0">
                                            <div id="div_status_<?= $category_item['alt_category_id'] ?>"
                                                class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input status-button"
                                                    data-status="<?= $category_item['status'] ?>"
                                                    data-id="<?= $category_item['alt_category_id'] ?>"
                                                  
                                                    id="chk_status_<?= $category_item['alt_category_id'] ?>"
                                                    <?php if($category_item['status'] == 'active'){ ?>checked
                                                    <?php } ?>>
                                                <label class="custom-control-label"
                                                    id="btn_status_<?= $category_item['alt_category_id'] ?>"
                                                    for="chk_status_<?= $category_item['alt_category_id'] ?>">
                                    ...
                                    <div class="nk-tb-col nk-tb-col-tools  text-end">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#editModalForm"
                                            data-item-id="<?= $category_item['alt_category_id'] ?>"
                                            data-title="<?= $category_item['alt_category_title'] ?>"
                                        ...
                                        <a href="#"
                                            ...
                                            data-item-id="<?= $category_item['alt_category_id'] ?>"><em
            ...
            <div class="modal-body bg-white">
                <form onsubmit="return false;" id="createCategoryForm" method="post" class="form-validate is-alter">
                    <div class="form-group">
                        <label class="form-label" for="alt_category_title"> <?php echo $title_new; ?> Adı</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl" id="alt_category_title"
                                name="alt_category_title" required>
                        </div>
                    </div>
                  
                    <div class="form-group">
                        <label class="form-label" for="alt_category_title">Sıralama</label>
                        <div class="form-control-wrap">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label class="form-label" for="image_upload">Görsel</label>
                            <div class="form-control-wrap">
                                <input type="hidden" id="upload_image" name="upload_image" value="">
                        <a class="gallery-image popup-image editPopups">
                            <img src="<?= base_url("uploads/default.png") ?>" alt="image" class="w-100 rounded-top editImgs">
                        </a>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-control-wrap">
                            <div id="stockImageDropZonee" class="upload-zone"
                                            data-url="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-white">
                <form id="editCategoryForm" method="post" class="form-validate is-alter" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="form-label" for="edit_alt_category_title"> <?php echo $title_new; ?> Adı</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl" id="edit_alt_category_title"
                                name="alt_category_title" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label class="form-label" for="image_upload">Görsel</label>
                            <div class="form-control-wrap">
                        <a class="gallery-image popup-image editPopup">
                            <img src="" alt="image" class="w-100 rounded-top editImg">
                        </a>
...
$('#categoryOlustur').click(function(e) {
    if ($('#alt_category_title').val() == '') {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '<?= route_to('tportal.stocks.altkategoriler.create') ?>',
            dataType: 'json',
            data: formData,
            async: true,
...
$('#modal_delete_category_button').on('click', function() {
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.altkategoriler.delete') ?>',
        dataType: 'json',
        data: {
            alt_category_id: item_id,
        },
        async: true,
        success: function (response) {
...
$('.edit-action').on('click', function() {
    ...
    $('#edit_alt_category_title').val(item_title);
...
if ($('#edit_category_title').val() == '') {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.altkategoriler.edit') ?>',
        dataType: 'json',
        data: formData,
        async: true,
        success: function(response) {
...
$('.status-button').on('change', function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.altkategoriler.edit.status') ?>',
        dataType: 'json',
        data: {
            status: status,
...
$('#close_modal_create').on('click', function(){
    alt_category_id = $(this).attr('data-category-id')
    $('#mdl_variant_category_list_'+alt_category_id).modal('toggle');
});
