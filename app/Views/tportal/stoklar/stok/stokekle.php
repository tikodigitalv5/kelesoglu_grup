...
<div class="nk-content nk-content-fluid">
  ...
  <li class="nav-item">
  <a class="nav-link active "  href="<?php echo route_to("tportal.stocks.depo_stoklari_ekle") ?>">
                        ...
                        <div class="card-inner position-relative card-tools-toggle">
                            <div class="card-title-group">
                                <div class="card-tools">
                                    <div class="">
                                    <h5 >Stoklarınızı Manuel Olarak Ekleyin  </h5>
                                    <p><b style="color: red; text-transform:uppercase;">Bu alanda elinizde kalan stoklarınızı barkodlu ürünlerinizi tekrar stoğa ekleme yapabilirsiniz.</b></p>
                                            ...
                                            <div class="col-6">
                                                   ...
                                                   <div class="form-group">
                                                        ...
                                                        <div style="background-color:#f5f6fa"  class="form-control form-control-xl" id="stock_code" name="stock_code">
                                                           Yeni Stok:  
                                                            <span style="font-weight:bold;font-family: monospace; margin-left: 38px; color: green;" id="fark">0.00</span> 
                                                        </div>
                                                        </div>
                                                </div>
                                                </div>
...
function submitOnEnter(event) {
    if (event.key === "Enter") {
        ...
        $.ajax({
            url: '<?php echo route_to("tportal.stock.getBarcodeEkle"); ?>',
            method: 'POST',
            dataType: 'json',
