...
<?= $this->section('page_title') ?> Ürün Tipleri <?= $this->endSection() ?>
<?= $this->section('title') ?> Ürün Tipleri | <?= session()->get('user_item')['firma_adi'] ?><?= $this->endSection() ?>
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Ürün Tipleri</h3>
                                                            ...
                                                            <div class="dropdown">
                                                                <a href="#" class="btn btn-icon btn-primary"
                                                                    ...
                                                                    data-bs-target="#createModalForm"><em
                                                                        ...
                                                                        class="ps-0 ms-0 pe-2">Yeni Ürün Tipi</span></a>
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head tb-tnx-head">
                                    ...
                                    <div class="nk-tb-col"><span class="sub-text">Ürün Tipi</span></div>
                              ...
                              foreach($type_items as $type_item){ ?>
                                ...
                                <div class="nk-tb-item" data-url="'.route_to('tportal.stoklar.detay').'"
                                    ...
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $type_item['order'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $type_item['type_title'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col tb-col-md">
                                        <div class="custom-control custom-switch ps-0">
                                            <div id="div_status_<?= $type_item['type_id'] ?>"
                                                class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input status-button"
                                                    data-status="<?= $type_item['status'] ?>"
                                                    data-id="<?= $type_item['type_id'] ?>"
                                                    id="chk_status_<?= $type_item['type_id'] ?>"
                                                    <?php if($type_item['status'] == 'active'){ ?>checked <?php } ?>>
                                                <label class="custom-control-label"
                                                    id="btn_status_<?= $type_item['type_id'] ?>"
                                                    for="chk_status_<?= $type_item['type_id'] ?>">
                                                    <?php if($type_item['status'] == 'active'){ echo 'Aktif'; }else{ echo 'Pasif'; } ?>
                                                </label>
                                            </div>
                                    ...
                                    <div class="nk-tb-col tb-col-md">
                                        <div class="custom-control custom-switch ps-0">
                                            <div id="div_default_<?= $type_item['type_id'] ?>"
                                                class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input default-button"
                                                    data-default="<?= $type_item['default'] ?>"
                                                    data-id="<?= $type_item['type_id'] ?>"
                                                    id="chk_default_<?= $type_item['type_id'] ?>"
                                                    <?php if($type_item['default'] == 'true'){ ?>checked <?php } ?>>
                                                <label class="custom-control-label"
                                                    id="btn_default_<?= $type_item['type_id'] ?>"
                                                    for="chk_default_<?= $type_item['type_id'] ?>">
                                                </label>
                                            </div>
                                    ...
                                    <div class="nk-tb-col nk-tb-col-tools  text-end">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#editModalForm"
                                            data-item-id="<?= $type_item['type_id'] ?>"
                                            data-title="<?= $type_item['type_title'] ?>"
                                            data-order="<?= $type_item['order'] ?>"
                                        ...
                                        <a href="#"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#modal_delete_type"
                                            data-item-id="<?= $type_item['type_id'] ?>"><em
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Yeni Ürün Tipi</h5>
                <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body bg-white">
                <form onsubmit="return false;" id="createTypeForm" method="post" class="form-validate is-alter">
                    <div class="form-group">
                        <label class="form-label" for="type_title">Ürün Tipi Adı</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl" id="type_title" name="type_title"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer d-block p-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-md-8 text-end p-0">
                        ...
                        <button type="button" id="typeOlustur" class="btn btn-lg btn-primary ">KAYDET</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="editModalForm">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ürün Tipi Düzenle</h5>
                <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body bg-white">
                <form onsubmit="return false;" id="editTypeForm" method="post" class="form-validate is-alter">
                    <div class="form-group">
                        <label class="form-label" for="type_title">Ürün Tipi Adı</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl" id="edit_type_title"
                                name="type_title" required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer d-block p-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-md-8 text-end p-0">
                        ...
                        <!-- <button type="button" id="btn_hesapyeniekle_mdl" class="btn btn-lg  btn-outline-light me-2">YENİ HESAP</button> -->
                        <button type="button" id="typeDuzenle" class="btn btn-lg btn-primary ">KAYDET</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
var item_id = 0;
$('#typeOlustur').click(function(e) {
    if ($('#type_title').val() == '') {
        swetAlert("Eksik Birşeyler Var", "Ürün Tipi Adı Giriniz.! ", "err");
    } else {
        var formData = $('#createTypeForm').serializeArray();
        formData.push({
            name: 'type_value',
            value: ''
        });
        $.ajax({
            ...
            type: 'POST',
            url: '<?= route_to('tportal.stocks.type.create') ?>',
            dataType: 'json',
            data: formData,
            async: true,
            success: function(response) {
                if (response['icon'] == 'success') {
                    ...
                    $("#trigger_type_ok_button").trigger("click");
                } else {
...
$('#modal_delete_type_button').on('click', function() {
    $.ajax({
        headers: {
            'X-CSRF-TOKEN': $('meta[name="X-CSRF-TOKEN"]').attr('content')
        },
        type: 'POST',
        url: '<?= route_to('tportal.stocks.type.delete') ?>',
        dataType: 'json',
        data: {
            type_id: item_id,
        },
...
$('.edit-action').on('click', function() {
    ...
    $('#edit_type_title').val(item_title);
    $('#edit_order').val(item_order);

    $('#typeDuzenle').click(function(e) {
        if ($('#edit_type_title').val() == '') {
            swetAlert("Eksik Birşeyler Var", "Ürün Tipi Adı Giriniz.! ", "err");
        } else {
            var formData = $('#editTypeForm').serializeArray();
            formData.push({
                name: 'type_value',
                value: ''
            });
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?= route_to('tportal.stocks.type.edit') ?>',
                dataType: 'json',
                data: formData,
                async: true,
                success: function(response) {
...
$('.status-button').on('change', function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.type.edit.status') ?>',
        dataType: 'json',
        data: {
            status: status,
            type_id: type_id
...
$('.default-button').on('click', function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.type.edit.default') ?>',
        dataType: 'json',
        data: {
            type_id: type_id
        },
