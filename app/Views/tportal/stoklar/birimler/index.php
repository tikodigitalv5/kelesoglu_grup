...
<?= $this->section('page_title') ?> Birimler <?= $this->endSection() ?>
<?= $this->section('title') ?> Birimler | <?= session()->get('user_item')['firma_adi'] ?><?= $this->endSection() ?>
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Birimler</h3>
                                                            ...
                                                            <div class="dropdown">
                                                                <a href="#" class="btn btn-icon btn-primary"
                                                                    ...
                                                                    data-bs-target="#createModalForm"><em
                                                                        ...
                                                                        class="ps-0 ms-0 pe-2">Yeni Birim</span></a>
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head tb-tnx-head">
                                    ...
                                    <div class="nk-tb-col"><span class="sub-text">Birim Adı</span></div>
                              ...
                              foreach($unit_items as $unit_item){ ?>
                                ...
                                <div class="nk-tb-item" data-url="'.route_to('tportal.stoklar.detay').'"
                                    ...
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $unit_item['order'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?= $unit_item['unit_title'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col tb-col-md">
                                        <div class="custom-control custom-switch ps-0">
                                            <div id="div_status_<?= $unit_item['unit_id'] ?>"
                                                class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input status-button"
                                                    data-status="<?= $unit_item['status'] ?>"
                                                    data-id="<?= $unit_item['unit_id'] ?>"
                                                    id="chk_status_<?= $unit_item['unit_id'] ?>"
                                                    <?php if($unit_item['status'] == 'active'){ ?>checked <?php } ?>>
                                                <label class="custom-control-label"
                                                    id="btn_status_<?= $unit_item['unit_id'] ?>"
                                                    for="chk_status_<?= $unit_item['unit_id'] ?>">
                                                    <?php if($unit_item['status'] == 'active'){ echo 'Aktif'; }else{ echo 'Pasif'; } ?>
                                                </label>
                                            </div>
                                    ...
                                    <div class="nk-tb-col tb-col-md">
                                        <div class="custom-control custom-switch ps-0">
                                            <div id="div_default_<?= $unit_item['unit_id'] ?>"
                                                class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input default-button"
                                                    data-default="<?= $unit_item['default'] ?>"
                                                    data-id="<?= $unit_item['unit_id'] ?>"
                                                    id="chk_default_<?= $unit_item['unit_id'] ?>"
                                                    <?php if($unit_item['default'] == 'true'){ ?>checked <?php } ?>>
                                                <label class="custom-control-label"
                                                    id="btn_default_<?= $unit_item['unit_id'] ?>"
                                                    for="chk_default_<?= $unit_item['unit_id'] ?>">
                                                </label>
                                            </div>
                                    ...
                                    <div class="nk-tb-col nk-tb-col-tools  text-end">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#editModalForm"
                                            data-item-id="<?= $unit_item['unit_id'] ?>"
                                            data-title="<?= $unit_item['unit_title'] ?>"
                                            data-order="<?= $unit_item['order'] ?>"
                                        ...
                                        <a href="#"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#modal_delete_unit"
                                            data-item-id="<?= $unit_item['unit_id'] ?>"><em
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Yeni Birim</h5>
                <a href="#" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <em class="icon ni ni-cross"></em>
                </a>
            </div>
            <div class="modal-body bg-white">
                <form onsubmit="return false;" id="createUnitForm" method="post" class="form-validate is-alter">
                    <div class="form-group">
                        <label class="form-label" for="unit_title">Birim Adı</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl" id="unit_title" name="unit_title"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="unit_title">Sıralama</label>
                        <div class="form-control-wrap">
            ...
            <div class="modal-footer d-block p-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-md-8 text-end p-0">
                        ...
                        <button type="button" id="unitOlustur" class="btn btn-lg btn-primary ">KAYDET</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="editModalForm">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body bg-white">
                <form onsubmit="return false;" id="editUnitForm" method="post" class="form-validate is-alter">
                    <div class="form-group">
                        <label class="form-label" for="unit_title">Birim Adı</label>
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl" id="edit_unit_title"
                                name="unit_title" required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer d-block p-3 bg-white">
                <div class="row">
                    ...
                    <div class="col-md-8 text-end p-0">
                        ...
                        <!-- <button type="button" id="btn_hesapyeniekle_mdl" class="btn btn-lg  btn-outline-light me-2">YENİ HESAP</button> -->
                        <button type="button" id="unitDuzenle" class="btn btn-lg btn-primary ">KAYDET</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    [
        ...
        'modals' => [
            'ok' => [
                ...
                'modal_buttons' => '<a href="#" data-bs-toggle="modal" data-bs-target="#createModalForm" class="btn btn-primary btn-block mb-2" data-bs-dismiss="modal">Yeni Birim Ekle</a>
                                    <a href="#" onclick="location.reload()" class="btn btn-l btn-dim btn-outline-dark btn-block">Birim Listesi</a>'
            ],
            'delete' => [
                'modal_title' => 'Bu Birimi Silmek İstediğinize<br>Emin misiniz?',
                'modal_text' => 'Bu birimi silmeden önce lütfen yetkilinize danışınız.',
            ]
        ],
    ]
); ?>
...
<script>
var item_id = 0;
$('#unitOlustur').click(function(e) {
    if ($('#unit_title').val() == '') {
        swetAlert("Eksik Birşeyler Var", "Birim Adı Giriniz.! ", "err");
    } else {
        var formData = $('#createUnitForm').serializeArray();
        formData.push({
            name: 'unit_value',
            value: ''
        });
        $.ajax({
            ...
            type: 'POST',
            url: '<?= route_to('tportal.stocks.unit.create') ?>',
            dataType: 'json',
            data: formData,
            async: true,
            success: function(response) {
                ...
                if (response['icon'] == 'success') {
                    ...
                    $("#trigger_unit_ok_button").trigger("click");
                } else {
...
$('#modal_delete_unit_button').on('click', function() {
    $.ajax({
        headers: {
            'X-CSRF-TOKEN': $('meta[name="X-CSRF-TOKEN"]').attr('content')
        },
        type: 'POST',
        url: '<?= route_to('tportal.stocks.unit.delete') ?>',
        dataType: 'json',
        data: {
            unit_id: item_id,
        },
...
$('.edit-action').on('click', function() {
    ...
    $('#edit_unit_title').val(item_title);
    $('#edit_order').val(item_order);

    $('#unitDuzenle').click(function(e) {
        if ($('#edit_unit_title').val() == '') {
            swetAlert("Eksik Birşeyler Var", "Birim Adı Giriniz.! ", "err");
        } else {
            var formData = $('#editUnitForm').serializeArray();
            formData.push({
                name: 'unit_value',
                value: ''
            });
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?= route_to('tportal.stocks.unit.edit') ?>',
                dataType: 'json',
                data: formData,
                async: true,
                success: function(response) {
...
$('.status-button').on('change', function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.unit.edit.status') ?>',
        dataType: 'json',
        data: {
            status: status,
            unit_id: unit_id
...
$('.default-button').on('click', function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        url: '<?= route_to('tportal.stocks.unit.edit.default') ?>',
        dataType: 'json',
        data: {
            unit_id: unit_id
        },
