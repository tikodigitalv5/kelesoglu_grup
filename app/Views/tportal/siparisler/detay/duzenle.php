                                                            ...
                                                            <div class="col-lg-3 col-sm-6 pe-sm-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php if(session()->get('user_id') == 13){ ?>
                                                                      <div class="form-control-wrap " style=" margin-top:3px;">
                                                                      <textarea class="form-control-lg form-control-xl" style="height: 110px !important; width: 423px;"id="text_varyant<?= $startZero ?>" 
                                                                         satir="<?= $startZero ?>"><?= str_replace('<br>', "\n", $order_row['varyantlar']) ?> </textarea>                                                                      </div>  
                                                                      <?php }else{ ?> 
                                                                        <div class="form-control-wrap d-none " style="float:right; margin-top:3px;">
                                                                        <textarea class="form-control-wrap "  id="text_varyant<?= $startZero ?>" satir="<?= $startZero ?>"><?= $order_row['varyantlar'] ?> </textarea>
                                                                      </div>  
                                                                        <?php } ?>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row  g-1">
                                                                    ...
                                                                    <div class="col-lg-4 col-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-control-wrap str_kaldir">
                                                                                <input type="text" class="form-control   text-end px-1 ftr_hesap para" id="txt_birim_fiyat_<?= $startZero ?>" placeholder="0,00" satir="<?= $startZero ?>" value="<?= number_format($order_row['unit_price'], session()->get('user_item')['para_yuvarlama'], ',', '.') ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap str_kaldir">
                                                        ...
                                                        <textarea class="form-control  form-control-lg form-control-xl" id="txt_fatura_not" name="txt_fatura_not" style="min-height: 200px;"><?= $order_item['order_note'] ?></textarea>
                                                    </div>
                                                </div>
...
<?php foreach($Kurlar as $kur): ?>
    kurlar.push({
        money_unit_id: <?php echo (int) $kur["money_unit_id"]; ?>, // Sayı ise tırnak olmamalı
        money_code: '<?php echo addslashes($kur["money_code"]); ?>', // String ise tırnak olmalı
        money_value: '<?php echo addslashes($kur["money_value"]); ?>',
        usdeuro: '<?php echo addslashes($kur["usdeuro"]); ?>',
        kur_fiyat_<?php echo addslashes($kur["money_code"]); ?>: '<?php echo addslashes($kur["money_value"]); ?>',
        kur_toplam_fiyat_<?php echo addslashes($kur["money_code"]); ?>: '0.00'
    });
<?php endforeach; ?>
