...
<?= $this->section('page_title') ?> Yeni Sipariş <?= $this->endSection() ?>
<?= $this->section('title') ?> Yeni Sipariş | <?= session()->get('user_item')['firma_adi'] ?><?= $this->endSection() ?>
                                        ...
                                        <div id="customer_info_area" class="d-none gy-2">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control  form-control-lg form-control-lg" name="invoice_title" id="invoice_title" value="" placeholder="Sipariş Ünvanı">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <textarea class="form-control  form-control-lg form-control-lg" name="address" id="address" cols="30" rows="5" placeholder="Sipariş Adresi"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane " id="tabItem3" role="tabpanel">
                                        ...
                                        <div class="row g-3 align-center">
                                            <div class="col-lg-5 col-xxl-3">
                                                <div class="form-group"><label class="form-label" for="site-name">Sipariş Türü</label>
                                                    <span class="form-note d-none d-md-block">Alınan: size verilen siparişi ifade eder, <br> Verilen: sizin verdiğiniz siparişi ifade eder,</span>
                                                </div>
                                            </div>
                                                ...
                                                <ul class="custom-control-group">
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-radio custom-control-pro">
                                                            <input type="radio" class="custom-control-input order_direction" name="order_direction" value="incoming" id="order_alis" checked>
                                                            <label class="custom-control-label" for="order_alis">Alınan </label>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="custom-control custom-control-sm custom-radio custom-control-pro">
                                                            <input type="radio" class="custom-control-input order_direction" name="order_direction" value="outgoing" id="order_satis">
                                                            <label class="custom-control-label" for="order_satis">Verilen</label>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="row g-3 align-center" id="siparis_durum_alani">
                                            <div class="col-lg-5 col-xxl-3 ">
                                                <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-xxl-5 col-6 mt-0 mt-md-2 pe-1">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-select-lg js-select2 form-control slct_order_status" data-ui="lg" id="slct_order_status" satir="0" data-ui="lg" data-placeholder="Seçiniz">
                                                            <option></option>
                                                            <option value="new" selected>Yeni Sipariş</option>
                                                ...
                                                <div class="col-lg-6 col-xxl-5 col-6 mt-0 mt-md-2 pe-1">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg date-picker" name="order_date" value="<?= date('d/m/Y') ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-xxl-5 col-4 mt-0 mt-md-2 ps-1">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg time-picker" name="order_time" value="<?= date('H:i') ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row g-3 align-center">
                                            <div class="col-lg-5 col-xxl-3 ">
                                                <div class="form-group">
                                                    ...
                                                    <span class="form-note d-none d-md-block">Sipariş fişi olarak kullan</span>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-xxl-7  mt-0 mt-md-4">
                                                <ul class="custom-control-group">
                                                    <li>
                                                        <div class="custom-control custom-checkbox custom-control-pro">
                                                            <input type="checkbox" class="custom-control-input" name="chx_quickSale" id="chx_quickSale">
                                        ...
                                        <div class="row g-3 align-center" id="termin_tarihi_alani">
                                            <div class="col-lg-5 col-xxl-3 ">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-xxl-7  mt-0 mt-md-4">
                                                <ul class="custom-control-group">
                                                    <li>
                                                        <div class="custom-control custom-checkbox custom-control-pro">
                                                            <input type="checkbox" class="custom-control-input" name="is_deadline" id="is_deadline">
                                        ...
                                        <div class="row g-3 align-center d-none" id="is_deadline_area">
                                            <div class="col-lg-5 col-xxl-3 ">
                                                <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-xxl-3 col-6 mt-0 mt-md-2 pe-1">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" class="form-control  form-control-lg form-control-lg date-picker" name="deadline_date" id="deadline_date" value="<?= date('d/m/Y') ?>" placeholder="Termin Tarihi">
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <button class="btn btn-outline-primary btn-dim btn_urun_sec" data-satir="" data-nereden="siparis" id="btn_urunSec"><span>Seç</span></button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap str_kaldir">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="input-group-append">
                                                                            <button class="btn btn-outline-primary btn-dim btn_urun_sec" data-nereden="siparis" data-satir="0"><span>Seç</span></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!--  <div class="form-control-wrap str_kaldir">
                                                            ...
                                                            <div class="row  g-1">
                                                                ...
                                                                <div class="col-lg-5 col-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-control-wrap str_kaldir">
                                                                            <select class="form-select js-select2 form-control  ftr_select select_birim_yeniSipariş" data-search="on" id="slct_birim_0" satir="0" data-placeholder="Seçiniz">
                                                                                <option></option>
                                        ...
                                        <div class="mt-5 bg-white">
                                            <button type="button" class="btn btn-secondary mb-2 btnPrevious" id="prevButton">Önceki</button>
                                            <button type="button" class="btn btn-success mb-2 btnSaveOrder" id="btnSaveOrder">Sipariş Kaydet</button>
                                        </div>
    ...
    [
        ...
        'modals' => [
            'ok' => [
                ...
                'modal_text' => 'Siprişiniz başarıyla oluşturuldu.',
                'modal_buttons' => '<a href="#" onclick="location.reload()" class="btn btn-primary btn-block mb-2" data-bs-dismiss="modal">Yeni Sipariş Oluştur</a>
                                    <a href="" id="orderDetail" class="btn btn-primary btn-block mb-2">Sipariş Detayına Git</a>
...
var kurlar = [];
    ...
    $(document).on("change", ".order_direction", function () {
        if (this.value == 'outgoing') {
            console.log("outgoing");
            $('#siparis_durum_alani').addClass('d-none');
            $('#termin_tarihi_alani').addClass('d-none');
            $('#is_deadline_area').addClass('d-none');

            if ($("#is_deadline").is(":checked")) {
                $('#is_deadline').prop('checked', false);
            }
        } else {
            console.log("incoming");
            $('#siparis_durum_alani').removeClass('d-none');
            $('#termin_tarihi_alani').removeClass('d-none');
        }
    });
    ...
    //termin tarihi
    // $('#is_deadline').change(function() {
    $(document).on("change", "#is_deadline", function () {
        if (this.checked) {
            $('#is_deadline_area').removeClass('d-none');
            is_deadline = 1;
        } else {
            $('#is_deadline_area').addClass('d-none');
            is_deadline = 0;
                ...
                success: function(data) {
                    ...
                    if (datas.response.unvan == '' && datas.response.adi == '' && datas.response.soyadi == '') {
                        ...
                        if (datas.icon == 'kayitli') {
                            ...
                            console.log("dbde kayıtlı değil");
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".setDateTimePicker", function() {
            ...
            var date2 = $('#deadline_date').datepicker('getDate');

            date2.setDate(date2.getDate() + parseInt(selectedDateValue))
            $("#deadline_date").datepicker("setDate", date2);
        });
