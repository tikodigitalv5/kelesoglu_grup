...
<?= $this->section('page_title') ?> Yeni Satış Emri <?= $this->endSection() ?>
<?= $this->section('title') ?> Yeni Satış Emri | <?= session()->get('user_item')['firma_adi'] ?>
<?= $this->endSection() ?>
            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content  d-xl-none">
                        <h3 class="nk-block-title page-title">Yeni Satış Emri</h3>
                    ...
                    <form onsubmit="return false;" id="create_sale_order_form" method="POST">
                        <div class="card-inner-group">
                                    ...
                                    <div class="row g-3 align-center">
                                        <div class="col-lg-3 ">
                                            <div class="form-group">
                                                ...
                                                <span class="form-note d-none d-md-block">Satış yapılacak müşteriyi seçin veya ekleyin.</span>
                                            </div>
                                        </div>
                                        <div class="col mt-0 mt-md-2">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-xl" id="account" name="account" value="<?= isset($cari_item) ? $cari_item['invoice_title'] == '' ? $cari_item['name'] . " " . $cari_item['surname'] : $cari_item['invoice_title'] : ''; ?>" placeholder="Müşteri seçmek için tıklayınız.." readonly="readonly">
                                                    <div class="input-group-append">
                                                        <a href="javascript;" id="btn_musteriSec" data-bs-toggle="modal" data-bs-target="#mdl_musteriSec" class="btn btn-lg btn-block btn-dim btn-outline-primary" <?= isset($cari_item) ? "style='pointer-events: none; cursor: default; opacity:0.53; '" : ""  ?>>Müşteri Seç</a>
                            ...
                            <div class="card-inner position-relative card-tools-toggle">
                                ...
                                <div class="row g-3 pt-3 align-center">
                                    <div class="col-lg-3 col-xxl-3 ">
                                        <div class="form-group"><label class="form-label" for="sale_order_quantity">Satış</label><span class="form-note d-none d-md-block">Satış yapılan ürün miktarı.</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-xxl-2 mt-0 mt-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row g-3 pt-3 align-center">
                                    <div class="col-lg-3 col-xxl-3 ">
                                        <div class="form-group"><label class="form-label" for="sale_order_quantity">Birim Fiyatı</label><span class="form-note d-none d-md-block">Satış yapılan ürünün birim fiyatı.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-xxl-2 mt-0 mt-md-2">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-xl calc" id="sale_unit_price" value="" placeholder="0,00" name="sale_unit_price" onkeypress="return SadeceRakam(event,[',']);">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-3 pt-3 align-center">
                                    <div class="col-lg-3 col-xxl-3 ">
                                        <div class="form-group"><label class="form-label" for="sale_order_total_amount">Toplam Fiyat</label><span class="form-note d-none d-md-block">Satış yapılan ürünün toplam fiyatı.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-xxl-2 mt-0 mt-md-2">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <div class="input-group">
                                                    <input type="text" name="sale_order_total_amount" disabled id="sale_order_total_amount" class="form-control form-control-xl text-right" placeholder="0,00" onkeypress="return SadeceRakam(event,[',']);">
                                                    <div class="input-group-append">
                        ...
                        <div class="card-inner position-relative card-tools-toggle">
                            <div class="gy-3">
                                <div class="row g-3 align-center">
                                    <div class="col-lg-3 col-xxl-3 ">
                                        <div class="form-group">
                                            <label class="form-label" for="site-name">Satış Yapılacak Ürünler</label><span class="form-note d-none d-md-block">Listedeki
...
<hr>
    ...
    <?php endforeach; ?>
                                ...
                                <div class="row g-3 align-center pt-5">
                                    <div class="col-lg-3 col-xxl-3 ">
                                        <div class="form-group"><label class="form-label" for="shipment_note">Sipariş Notu</label>
                                            <span class="form-note d-none d-md-block">Sipariş ile ilgili notunuz varsa yazınız.</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-9 col-xxl-9 mt-0 mt-md-2">
                                        <div class="form-group">
                                ...
                                <div class="d-none gy-2" id="area_has_collection">
                                    <div class="row g-3 align-center">
                                        <div class="col-lg-3 col-xxl-3 ">
                                            <div class="form-group">
        ...
        if (event.which === 13) {
            ...
            if (elementWithBarcode.length > 0) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?= route_to('tportal.cari.sale_order.check_barcode') ?>',
                    dataType: 'json',
                    data: {
      ...
      setTimeout(() => {
        ...
        if (parseFloat($('#from_warehouse').val()) != 0 &&
            ...
            if ($("#sale_order_quantity").val() > kalanMiktar) {
                ...
                if ($('#sale_order_quantity').val() == 0 || $('#sale_order_quantity').val() == '' || $('#sale_order_quantity').val() == undefined || $('#sale_order_total_amount').val() == 0 || $('#sale_order_total_amount').val() == '' || $('#sale_order_total_amount').val() == NaN) {
            ...
            if ($('#from_warehouse').find(":selected").val() == 0) {
                ...
                swetAlert("Hatalı İşlem", "Lütfen döviz kur bilgisini giriniz", "err");
                    ...
                    Swal.fire({
                        ...
                        html: 'Hızlı satış faturanız sisteme kaydedilecektir.',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Hızlı satış faturanız oluşturuluyor, lütfen bekleyiniz...',
                                html: 'Hızlı satış faturanız oluşturulurken lütfen bekleyiniz...',
                                allowOutsideClick: false,
                                onBeforeOpen: () => {
                                    Swal.showLoading();
                                },
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                url: '<?= route_to('tportal.cari.sale_order_store') ?>',
                                dataType: 'json',
                                data: {
                                    formData: form_data,
