<div class="gy-3">
                                        ...
                                        <div class="row g-3 align-center">
                                            <div class="col-lg-5 col-xxl-5 ">
                                                <div class="form-group"><label class="form-label" for="stock_code">Kalıp
                                                        Adresi</label><span
                                                        class="form-note d-none d-md-block">Gözükecek
                                                        kalıp adresi.</span></div>
                                            </div>
                                            <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                <div class="form-group">
                                                    <div class="form-control-wrap"><input type="text"
                                                            class="form-control form-control-xl" id="stock_code"
                                                            value="<?= $stock_item['pattern_code'] ?>"
                                                            name="pattern_code" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-8 pe-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text"
                                                                ...
                                                                value="<?= number_format($stock_item['unit_price'], 4, ',', '') ?>"
                                                            ...
                                                            <div class="form-control-select">
                                                                <select required=""
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        <?php if($money_unit_item['money_unit_id'] == $stock_item['money_unit_id']){ echo 'selected'; } ?>>
                                            ...
                                            <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                <div class="form-group">
                                                    <div class="form-control-wrap"><input type="text"
                                                            ...
                                                            value="" placeholder="critical_stock" name="critical_stock">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="form-control-select">
                                                            <select required=""
                                                                ...
                                                                <option value="<?= $unit_item['unit_id'] ?>"
                                                                    <?php if($stock_item['unit_id'] == $unit_item['unit_id']){ echo 'selected'; } ?>>
