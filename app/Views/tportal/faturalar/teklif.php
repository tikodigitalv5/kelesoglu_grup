...
<div class="nk-content nk-content-fluid">
                                        ...
                                        <div class="row g-3 align-center">
                                            ...
                                            <div class="d-flex flex-nowrap col-lg-7 col-xxl-7">
                                                ...
                                                <div class="col-lg-4 col-xxl-5 col-4 mt-0 mt-md-2 ps-1 d-none" id="txt_doviz_kuru_area">
                                                    <div class="input-group">
                                                        <input type="text" name="txt_doviz_kuru" id="txt_doviz_kuru" class="form-control form-control-lg form-control-lg text-end doviz_degis "  placeholder="0,0000" value="<?= number_format($siparis['currency_amount'],2,',','.') ?>" onkeypress="return SadeceRakam(event,[',']);">
                                                        <div class="input-group-append">
    ...
    foreach ($invoice_rows as $invoice_row) { ?>
        <div class="row no-gutters mb-2 ftr_str" id="Satir_<?= $startZero ?>" visible="true" offer_row_id="<?= $invoice_row['offer_row_id'] ?>" offer_row_id="0" invoice_row_id="0">
            <div class="col-lg-11">
                <div class="row no-gutter">
                    <div class="col-lg-3 col-sm-6 pe-sm-1">
                        <div class="form-group">
    ...
    $startZero += 1;
                                        ...
                                        <input type="hidden" id="offer_id" value="<?php  echo $offer_id; ?>">
                                        ...
                                        <div class="mt-5 bg-white">
                                            <button type="button" class="btn btn-secondary mb-2 btnPrevious" id="prevButton">Önceki</button>
                                            <button type="button" class="btn btn-success mb-2 btnSaveTeklif" data-offer_id="<?php  echo $offer_id; ?>"  id="btnSaveTeklif">Faturayı Oluştur</button>
                                        </div>
...
$(window).on('load', function() {
    setTimeout(() => {
    // Değeri ayarla
    $(".doviz_degis").val('<?= number_format($siparis['currency_amount'],2,',','.') ?>');

    // Keyup olayını manuel tetikle
    $(".doviz_degis").trigger('keyup'); // keyup olayını tetikle
}, 2500);
    $("#slct_doviz_tipi").val(<?php echo $siparis["money_unit_id"]; ?>);

    // Değişiklik olayını tetikle
    $("#slct_doviz_tipi").change();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response['icon'] == 'success') {
                        ...
                        console.log("Sorgulama Ülke " + fullData.address_country);
