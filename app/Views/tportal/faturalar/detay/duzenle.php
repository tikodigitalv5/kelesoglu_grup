...
<?= $this->section('page_title') ?> Fatura Detay <?= $this->endSection() ?>
<?= $this->section('title') ?> Fatura Detay | <?= $invoice_item['invoice_no'] ?> <?= $this->endSection() ?>
                                ...
                                <form onsubmit="return false;" id="editCari" method="post">
                                    <div class="card-inner position-relative card-tools-toggle p-0">
                                        <div class="gy-2">
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-lg" id="identification_number" placeholder="T.C. veya Vergi No Giriniz.." value="<?= $cari_item['identification_number'] ?>" name="identification_number" maxlength="11">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <?php
                                            if ($cari_item['company_type'] == 'person') { ?>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input type="text" class="form-control form-control-lg" id="tax_administration" name="tax_administration" value="<?= $cari_item['tax_administration'] ?>" placeholder="ULUDAĞ VERGİ DAİRESİ MÜD."></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap"><input name="cari_email" type="text" class="form-control form-control-lg" id="cari_email" value="<?= $cari_item['cari_email'] ?>" placeholder="test@example.com"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-6 col-xxl-7 mt-0 mt-md-2">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg" name="cari_phone" id="cari_phone" aria-label="Text input with dropdown button" placeholder="000 000 00 00" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
