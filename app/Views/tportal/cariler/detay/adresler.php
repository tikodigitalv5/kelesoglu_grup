                                    ...
                                    <table class="datatable-init-hareketler nowrap table" data-export-title="Export">
                                        <thead>
                                            <tr style="background-color: #ebeef2;">
                                                <th style="background-color: #ebeef2;" data-orderable="false">Adres Türü</th>
                                                <th style="background-color: #ebeef2;" data-orderable="false">Şehir</th>
                    ...
                    <div class="row mb-3 align-center">
                        ...
                        <div class="col-lg-6 col-xxl-6 ">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap" id="ilDegisiklik2">
                        ...
                        <div class="col-lg-6 col-xxl-6 ">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap" id="IlceDegisiklik2">
                        ...
                        <div class="col-lg-6 col-xxl-6 ">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap" id="ilDegisiklik">
                                    <select id="Iller2" name="edit_address_city" class="form-select js-select2 otomatikUlke" data-ui="lg" data-placeholder="İl Seçiniz" data-search="off">
                        ...
                        <div class="col-lg-6 col-xxl-6 ">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap" id="IlceDegisiklik">
                                    <select id="Ilceler2" name="edit_address_district" class="form-select js-select2 otomatikUlke" data-ui="lg" data-placeholder="İlçe Seçiniz" data-search="off">
...
var SehirDiv2 = $("#ilDegisiklik2");
var IlceDiv2 = $("#IlceDegisiklik2");
...
if(selectedValue != "TR"){
   ...
   setTimeout(() => {
    ...
    $("#IlceDegisiklik2").html('');

    $("#ilDegisiklik2").append(sehir2InputTemplate);

    $("#IlceDegisiklik2").append(Ilce2InputTemplate);
    ...
    $("#ilDegisiklik2").html(sehir2Template);

    $("#IlceDegisiklik2").html(Ilce2Template);



    // İl seçimi için
    $('#Iller').select2({
        dropdownParent: $('#mdl_adres')
    });
    ...
    if($('#Iller').val() > 0) {
        ...
        $('#Ilceler2').html('');
        $('#Ilceler2').append($('<option>', {
        value: 0,
        text:  'Lütfen Bir İlçe seçiniz'
        }));
        $('#Ilceler2').prop("disabled", false);
    ...
    $('#Ilceler').prop("disabled", true);
        ...
        $('#mdl_edit_cari_address').on('shown.bs.modal', function () {
    // Ülke seçimi için
    $('#edit_address_country').select2({
        dropdownParent: $('#mdl_edit_cari_address')
    });
    ...
    $('#Ilceler2').select2({
        ...
        $("#edit_address_country").on("change", function() {
            ...
            var sehir2Template = '<select id="Iller2" name="edit_address_city" class="form-select js-select2 otomatikUlke" data-ui="lg" data-placeholder="İl Seçiniz" data-search="off"> <option value="0" disabled>İl seçiniz</option></select>  <input type="hidden" class=" form-control  form-control-lg form-control-lg" placeholder="İlçe Giriniz"  name="edit_address_city_name" id="edit_address_city_name" >';
            var Ilce2Template = '<select id="Ilceler2" name="edit_address_district" class="form-select js-select2 otomatikUlke" data-ui="lg" data-placeholder="İlçe Seçiniz" data-search="off"> <option value="0" selected disabled>İlçe seçiniz</option></select>';

            var sehir2InputTemplate = '<input type="text" class="manuelUlke form-control  form-control-lg form-control-lg" placeholder="İl Giriniz"  name="edit_address_city" id="edit_address_city">  <input type="hidden" class=" form-control  form-control-lg form-control-lg" placeholder="İlçe Giriniz"  name="edit_address_city_name" id="edit_address_city_name" >';
            var Ilce2InputTemplate = '<input type="text" class="manuelUlke form-control  form-control-lg form-control-lg" placeholder="İlçe Giriniz"  name="edit_address_district" id="edit_address_district">';
            ...
            if(selectedValue != "TR"){
               ...
               setTimeout(() => {
                $("#edit_address_city").on("keyup", function() {
                    $("#edit_address_city_name").val($(this).val());
                });
               }, 500);
                ...
                setTimeout(() => {
                    $("#edit_address_city_name").val($("#Iller2 option:selected").text());
                ...
                if($('#Iller2').val() > 0) {
                    ...
                    $('#Ilceler2').prop("disabled", false);
                    var resultObject = search($('#Iller2').val(), data);
                    $.each(resultObject.ilceleri.sort(), function( index, value ) {
                    $('#Ilceler2').append($('<option>', {
                        value: value,
                        text:  value
        ...
        $(".editCariAddress").each(function(index) {
            ...
            $(this).on("click", function() {
                ...
                $('#edit_address_country').val(edit_address_country).trigger('change');
                $('#edit_address_country').select2().trigger('change');

                //edit modal'ında il ilçe value olarak plaka basılması gerekiyor. ama elimizde sadece il ilçe bilgisinin ismi var.
        

                var SecilenUlke = edit_address_country;
                var SehirDiv2 = $("#ilDegisiklik");
                var IlceDiv2 = $("#IlceDegisiklik");
                var sehir2Template = '<select id="Iller2" name="edit_address_city" class="form-select js-select2 otomatikUlke" data-ui="lg" data-placeholder="İl Seçiniz" data-search="off"> <option value="0" disabled>İl seçiniz</option></select>  <input type="hidden" class=" form-control  form-control-lg form-control-lg" placeholder="İlçe Giriniz"  name="edit_address_city_name" id="edit_address_city_name" >';
                var Ilce2Template = '<select id="Ilceler2" name="edit_address_district" class="form-select js-select2 otomatikUlke" data-ui="lg" data-placeholder="İlçe Seçiniz" data-search="off"> <option value="0" selected disabled>İlçe seçiniz</option></select>';
               ...
               setTimeout(() => {
                $("#edit_address_city").on("keyup", function() {
                    ...
                    $('#edit_address_city').val(edit_address_city);

                    $('#edit_address_district').val(edit_address_district);

                    $("#edit_address_city_name").val($("#edit_address_city").val());
