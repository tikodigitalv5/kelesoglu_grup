                                        ...
                                        foreach($financialMovements as $movement): ?>
                                            <tr>
                                                ...
                                                <td style="width: 80px !important;">
                                                    <?php if($movement["transaction_type"] == "payment"): ?>
...
window.addEventListener('load', function() {
    ...
    $('.btnNext').on('click', function () {
        ...
        var newPageURL = base_url + '/tportal/reports/detayli-odeme-raporlarim/' + startDateFormatted + '/' + endDateFormatted + '/' + currency + '/' + musteri;
