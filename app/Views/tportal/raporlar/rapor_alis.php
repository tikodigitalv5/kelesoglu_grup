...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = NioApp.DataTable('#datatableInvoice', {
            ...
            stateSave: true,
            ajax: {
                url: base_url + '/tportal/reports/incoming_datatable',
                data: function (d) {
...

            {
                ...
                render: function (data) {
                    ...
                    if(data.type == "gider"){
                        data.status_name = "Gider";
                        data.status_info = "warning";
                    }
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    if(data.type == "gider"){
                        invoice_scenario_textd = '';
                        invoice_scenario_texts = "Gider";
                    } else {
                        invoice_scenario_texts = data.invoice_direction == 'incoming_invoice' ? "Alış" : "Satış";
                        invoice_scenario_textd = invoice_scenario_text;
                    }
                    return `
                        <td class="nk-tb-col tb-col-lg">
                            <span class="tb-lead">${invoice_scenario_texts}</span>
                            <span> ${ invoice_scenario_textd } </span>
                        </td>
                        `;
                }
            },
