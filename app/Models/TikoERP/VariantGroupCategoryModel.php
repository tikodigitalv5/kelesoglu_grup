...
class VariantGroupCategoryModel extends Model {

    protected $table      = 'variant_group_category';
    protected $primaryKey = 'variant_group_category_id';
    ...
    protected function afterInsert(array $data){
        ...
        $log_data = [
            ...
            'model_name' => 'variant_group_category',
            'affected_id' => $data['id'],
