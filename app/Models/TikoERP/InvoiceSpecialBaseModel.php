...
class InvoiceSpecialBaseModel extends Model {

    protected $table      = 'invoice_special_base_list';
    protected $primaryKey = 'invoice_special_base_list_id';
    ...
    protected function afterInsert(array $data){
        ...
        $log_data = [
            ...
            'model_name' => 'invoice_special_base_list',
            'affected_id' => $data['id'],
