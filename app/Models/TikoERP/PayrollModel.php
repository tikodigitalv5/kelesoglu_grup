...
class PayrollModel extends Model {
    ...
    protected $allowedFields  = [
        # payroll_type => 'check' || 'bill'
        # if(payroll_type == check) => payroll_owner_id == bank_id
        # if(payroll_type == bill) => payroll_owner_id == cari_id || null

        # if(payroll_status == active) => Çek açık
        # if(payroll_status == passive) => Ciro Edildi
        'user_id',
        'payroll_owner_id',
        'money_unit_id',
        'payroll_type',
