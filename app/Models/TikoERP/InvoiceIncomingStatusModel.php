...
class InvoiceIncomingModel extends Model {

    protected $table      = 'invoice_incoming_status';
    protected $primaryKey = 'invoice_incoming_status_id';
    ...
    protected function afterInsert(array $data){
        ...
        $log_data = [
            ...
            'model_name' => 'invoice_incoming_status',
            'affected_id' => $data['id'],
