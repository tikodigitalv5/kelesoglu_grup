...
class InvoiceExceptionTypeModel extends Model {

    protected $table      = 'invoice_exception_list';
    protected $primaryKey = 'invoice_exception_list_id';
    ...
    protected function afterInsert(array $data){
        ...
        $log_data = [
            ...
            'model_name' => 'invoice_exception_list',
            'affected_id' => $data['id'],
