...
!function (NioApp, $) {
  ...
  $('#tiko_input_search').keyup(function() {
    var table = $('.datatable-init').DataTable();
    table.search($(this).val()).draw();
});


$('#tiko_input_searchs').keyup(function() {
  var table = $('.datatable-inits').DataTable();
  table.search($(this).val()).draw();
});


$('#tiko_input_searchss').keyup(function() {
  var table = $('.datatable-initss').DataTable();
  table.search($(this).val()).draw();
});

$('#tiko_input_search_urunler').keyup(function() {
  var table = $('.datatable-inits_urunler').DataTable();
  table.search($(this).val()).draw();
});
